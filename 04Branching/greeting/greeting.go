...
func TypeSwitchTest(x interface{}) { //interface in this case is similar to object in c#...it can be any type
	switch x.(type) { // switching on type of the variable passed in
	case int:
		fmt.Println("int")
	case string:
		fmt.Println("string")
